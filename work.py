...
Bias_detection = Task(
  ...
  expected_output="""A comprehensive bias detection report containing:
  ...
  output_file="task_outputs/bias_detection.md"
)
...
Explains_issue = Task(
  ...
  expected_output="""
     A detailed fairness and explanation report containing:
      ...
      output_file="task_outputs/bias_explanation.md",
...
Fix = Task(
  ...
  expected_output="""
   A detailed bias mitigation report containing:
      ...
      output_file="task_outputs/bias_fix.md",

      context=[Bias_detection, Explains_issue]
...
Update = Task(
  ...
  expected_output=""" A model update report containing:
     ...
     output_file="task_outputs/bias_update.md",

      context=[Bias_detection, Explains_issue, Fix]
...
# EXPECTED OUTPUT FOR LOG GENERATOR
  ...
  expected_output="""A structured log dataset containing:
        ...
        output_file="task_outputs/bias_log.md",

        context=[Bias_detection, Explains_issue, Fix, Update]
...
agent=Log_insights,
  ...
  expected_output="""A log analysis report containing:
  ...
  output_file="task_outputs/bias_log_insights.md", 
  
  context=[Bias_detection, Explains_issue, Fix, Update, Log_generate]
