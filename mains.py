...
from work import (Bias_detection,Explains_issue,Correction_advise,Updates_data,Log_generation,Insights_data)
...
Ethos_crew = Crew(
  ...
  tasks=[Bias_detection, Explains_issue, Correction_advise, Updates_data, Log_generation, Insights_data ],
